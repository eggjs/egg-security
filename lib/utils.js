...
exports.isSafeDomain = function(domain, domain_white_list) {
...
exports.pathToReg = function(strPath) {
...
exports.checkIfIgnore = function(opts, path) {
  // 先检查 enable
...
exports.merge = function(origin, opts) {
