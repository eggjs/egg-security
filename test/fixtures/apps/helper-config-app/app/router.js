...
module.exports = function(app) {
  app.get('/shtml-configuration', function*() {
  ...
  app.get('/shtml-extending-domainList-via-config.helper.shtml.domainWhiteList', function*() {
  ...
  app.get('/shtml-stripe-css-url', function*() {
