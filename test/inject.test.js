    ...
    it('should inject nonce', function(done) {
      this.app.httpRequest()
        ...
        .end(function(err, res) {
          ...
          scriptTag.should.equal(`<script nonce="${expectedNonce}"></script><script nonce="${expectedNonce}"></script><script nonce="${expectedNonce}"></script><script nonce="${expectedNonce}"></script><script nonce="${expectedNonce}"></script><script nonce="${expectedNonce}"></script>`);
          done();
        });
    });
